...
,
    ...
    {
        foreach ($this->staticCallsToNews as $singleStaticCallsToNews) {
            if (! $this->isName($node->class, $singleStaticCallsToNews->getClass())) {
                continue;
            }

            if (! $this->isName($node->name, $singleStaticCallsToNews->getMethod())) {
                continue;
            }
